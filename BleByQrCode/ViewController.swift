...
//  BleByQrCode
//
//  Created by Chhagan Singh on 24/08/18.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var btnDeviceAddress: UIButton!
   ...
   // @IBOutlet var topbar: UIView!
    ...
    override func viewDidLoad() {
        ...
        if let qrCodeFrame = qrCodeFrame {
            ...
            qrCodeFrameView.addSubview(qrCodeFrame)
    ...
    @IBAction func startReadingQrCode(_ sender: Any)
    {
        // Start video capture.
    ...
    func launchApp(decodedURL: String) {
        ...
        btnDeviceAddress .setTitle(messageLabel.text, for: .normal)
...
extension ViewController: AVCaptureMetadataOutputObjectsDelegate {
    ...
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if metadataObjects.count == 0 {
            ...
            btnDeviceAddress.isHidden = true
            return
        }
        ...
        if supportedCodeTypes.contains(metadataObj.type) {
            ...
            if metadataObj.stringValue != nil {
                ...
                btnDeviceAddress.isHidden = false
            }
        }
    }
