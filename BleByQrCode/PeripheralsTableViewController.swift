...
class PeripheralsTableViewController: UITableViewController, CBCentralManagerDelegate {
    ...
    // MARK: - start scanning blutooth device
    ...
    // MARK: - stop scanning blutooth device
    ...
    // cb central manager delegate function
    func centralManagerDidUpdateState(_ central: CBCentralManager)
    {
     ...
     // MARK: - bluetooth device discovered near you
    ...
    // MARK: - result either get connected or not
